...
class Commands(Cog):
    ...
    async def info(self, interaction: ApplicationCommandInteraction):
        embed = Embed(
            title=self.bot.get_text(
                "command.info.embed.title", interaction.locale, "機器人資訊"
            ),
            color=0x2B2D31,
        )
        ...
        embed.add_field(
            name=self.bot.get_text(
                "command.info.embed.start_time", interaction.locale, "啟動時間"
            ),
        ...
        embed.add_field(
            name=self.bot.get_text(
                "command.info.embed.commit_hash", interaction.locale, "版本資訊"
            ),
        ...
        embed.add_field(
            name=self.bot.get_text(
                "command.info.embed.guilds", interaction.locale, "伺服器數量"
            ),
        ...
        embed.add_field(
            name=self.bot.get_text(
                "command.info.embed.players", interaction.locale, "播放器數量"
            ),
    ...
    async def ping(self, interaction: ApplicationCommandInteraction):
        await interaction.response.send_message(
            embed=InfoEmbed(
                self.bot.get_text(
                    "command.ping.title", interaction.locale, "機器人延遲"
                ),
    ...
    @commands.slash_command(
        ...
        options=[
            ...
            Option(
                name="shuffle",
                description=Localized(
                    "是否開啟隨機播放模式", key="command.play.option.shuffle"
                ),
    ...
    async def play(
        ...
        if not results or not results.tracks:
            self.bot.logger.info(
                "No results found with local sources for query %s, checking on lavalink",
                query,
            )
        ...
        filter_warnings = (
            [
                InfoEmbed(
                    title=self.bot.get_text(
                        "command.play.filter_warning.title", interaction.locale, "提醒"
                    ),
                    description=str(
                        self.bot.get_text(
        ...
        await player.update_display(
            await interaction.original_response(), delay=5, locale=interaction.locale
        )
    ...
    async def skip(
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                self.bot.get_text(
                    "command.skip.success", interaction.locale, "已跳過歌曲"
                )
            )
        )
    ...
    async def remove(self, interaction: ApplicationCommandInteraction, target: int):
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                self.bot.get_text(
                    "command.remove.success", interaction.locale, "已移除歌曲"
                )
            )
        )
    ...
    async def clean(self, interaction: ApplicationCommandInteraction):
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                self.bot.get_text(
                    "command.clean.success", interaction.locale, "已清除播放序列"
                )
            )
        )
    ...
    async def pause(self, interaction: ApplicationCommandInteraction):
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                self.bot.get_text(
                    "command.pause.success", interaction.locale, "已暫停歌曲"
                )
            )
        )
    ...
    async def resume(self, interaction: ApplicationCommandInteraction):
        ...
        if not player.paused:
            return await interaction.edit_original_response(
                embed=ErrorEmbed(
                    self.bot.get_text(
                        "command.pause.error.nothing_paused",
                        interaction.locale,
                        "沒有暫停的歌曲",
                    )
                )
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                self.bot.get_text(
                    "command.resume.success", interaction.locale, "已繼續歌曲"
                )
            )
        )
    ...
    async def volume(self, interaction: ApplicationCommandInteraction, value: int):
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                self.bot.get_text(
                    "command.volume.success", interaction.locale, "已設定音量為 "
                )
                + f"`{value}`"
            )
        )
    ...
    async def stop(self, interaction: ApplicationCommandInteraction):
        ...
        await player.update_display(
            await interaction.original_response(), locale=interaction.locale
        )
    ...
    async def connect(self, interaction: ApplicationCommandInteraction):
        ...
        try:
            ...
            await interaction.edit_original_response(
                embed=WarningEmbed(
                    self.bot.get_text(
                        "command.connect.error.already_in_channel.title",
                        interaction.locale,
                        "警告",
                    ),
                    self.bot.get_text(
    ...
    async def queue(self, interaction: ApplicationCommandInteraction):
        ...
        if not player or not player.queue:
            return await interaction.response.send_message(
                embed=ErrorEmbed(
                    self.bot.get_text(
                        "command.queue.error.empty", interaction.locale, "播放序列為空"
                    )
                )
            )
        ...
        for iteration, songs_in_page in enumerate(split_list(player.queue, 10)):
            pages.append(
                InfoEmbed(
                    title=self.bot.get_text(
                        "command.queue.title", interaction.locale, "播放序列"
                    ),
                    description="\n".join(
                        [
    ...
    async def timescale(self, interaction: ApplicationCommandInteraction, **kwargs):
        await self.update_filters(interaction, "timescale", **kwargs)
    ...
    async def tremolo(self, interaction: ApplicationCommandInteraction, **kwargs):
        await self.update_filters(interaction, "tremolo", **kwargs)
    ...
    async def vibrato(self, interaction: ApplicationCommandInteraction, **kwargs):
        await self.update_filters(interaction, "vibrato", **kwargs)
    ...
    async def rotation(self, interaction: ApplicationCommandInteraction, **kwargs):
        await self.update_filters(interaction, "rotation", **kwargs)
    ...
    async def lowpass(self, interaction: ApplicationCommandInteraction, **kwargs):
        await self.update_filters(interaction, "lowpass", **kwargs)
    ...
    async def bassboost(self, interaction: ApplicationCommandInteraction):
        ...
        await self.update_filters(interaction, "equalizer", player=player)
    ...
    async def update_filters(
        ...
        **kwargs,
        ...
        player = player or self.bot.lavalink.player_manager.get(interaction.guild.id)

        if isinstance(filter_names, str):
            filter_names = [filter_names]

        if not kwargs and not isinstance(interaction, MessageInteraction):
            await self._remove_filters(interaction, player, filter_names)
        else:
            await self._set_filters(interaction, player, filter_names, **kwargs)
    ...
    async def _remove_filters(
        self, interaction: Interaction, player: LavaPlayer, filter_names: list[str]
    ):
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                f"{self.bot.get_text('command.filters.removed', interaction.locale, '已移除效果器')}：{', '.join(allowed_filters[name].__name__ for name in filter_names)}"
            )
        )
    ...
    async def _set_filters(
        ...
        **kwargs,
        ...
        for filter_name in filter_names:
            audio_filter = (
                player.get_filter(filter_name) or allowed_filters[filter_name]()
            )
            ...
            try:
                ...
                await interaction.edit_original_response(
                    embed=ErrorEmbed(
                        self.bot.get_text(
                            "command.filters.invalid_params",
                            interaction.locale,
                            "請輸入有效的參數",
                        )
                    )
        ...
        await interaction.edit_original_response(
            embed=SuccessEmbed(
                f"{self.bot.get_text('command.filters.set', interaction.locale, '已設置效果器')}：{', '.join(allowed_filters[name].__name__ for name in filter_names)}"
            )
        )
